...
// Allows you to define to a component in north, which isn't built until the component is
// instantiated
export default class northComponent extends WrappedComponent {
  _className = 'northComponent';
