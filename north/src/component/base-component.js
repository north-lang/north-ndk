...
export default class BaseComponent extends events.EventEmitter {
  ...
  _getBaseComponentSchema() {
    return {
      ...
      fields: [
        {
          // This field is just for the north definition
          name: 'component',
          component: 'TextField'
        },
        {
  ...
  _setIfDifferent(name, value) {
    ...
    // we have no construct for detecting when properties are omitted from a north definition.
  ...
  getClassName() {
    ...
    // if (this._className) {
    //   // The component was generated via north and so the contructor.name is inaccurate
