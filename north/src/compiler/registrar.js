...
// north-core and north-server. We must do this as there can only be a single instance of
// babel-polyfill. Unfortunately, react-scripts does not allow us to use code from north-server
