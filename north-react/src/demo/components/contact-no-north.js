...
import { TextField, EmailField, ButtonField } from 'north/lib/fields';
...
class ContactNonorth extends Form {
  _create(props) {
    super._create(props);
...
compiler.registerComponent('app.ContactNonorth', ContactNonorth);
